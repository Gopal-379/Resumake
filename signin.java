...
public class signin extends HttpServlet
{
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:system", "system", "gopal");
            ...
            if(username == null)
            {
                ...
                out.println("<a href=\"./index.html\"> <input class=\"button\" type=\"button\" value=\"Go\"> </a>");
                out.println("</div>");
                out.println("</html>");
            }
            else
            {
                ...
                stmt.execute("delete from signin_log_resumemake");
                stmt.execute("insert into signin_log_resumemake values(\'" + emailid + "\')");
                out.println("<a href=\"./index/index.html\"> <input class=\"button\" type=\"button\" value=\"Go\"> </a>");
                out.println("</div>");
                out.println("</html>");
            }
            con.close();
